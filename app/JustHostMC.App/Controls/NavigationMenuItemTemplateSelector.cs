...
/// <summary>Selects the static Home row or a data-bound server row in the navigation menu.</summary>
public sealed partial class NavigationMenuItemTemplateSelector : DataTemplateSelector
{
