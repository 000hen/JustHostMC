...
/// <summary>
/// Tracks whether the one-time "servers run directly on your machine" notice has
/// been shown (PROMPT §6, §10.7). Backed by a marker file under local app data.
/// </summary>
public sealed class FirstRunService
{
    ...
    {
        var baseDir = Environment.GetEnvironmentVariable("MCMANAGER_DATA_DIR")
