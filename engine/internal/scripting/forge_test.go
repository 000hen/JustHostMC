...
// TestForgeBuiltin verifies the embedded forge.lua parses and declares the
...
func TestForgeBuiltin(t *testing.T) {
	...
	if !hasNetwork {
		t.Error("forge should declare the network permission")
	}
}
