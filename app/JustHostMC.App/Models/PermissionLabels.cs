...
/// their human-readable labels (shown in the consent dialog and script cards).</summary>
public static class PermissionLabels
{
    ...
    public static string Label(PermissionKind kind, ILocalizer localizer) => localizer.Get(LabelKey(kind));
}
