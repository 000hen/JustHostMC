...
/// <summary>
/// Shared responsive shell for pages that show primary content plus custom
/// filters. The filter implementation stays with the consuming page; this
/// control owns the wide filter rail and compact filter flyout behavior.
/// </summary>
public sealed partial class AdaptiveFilterLayout : UserControl {
    ...
    public static readonly DependencyProperty WideFilterContentProperty =
        DependencyProperty.Register(nameof(WideFilterContent), typeof(object),
                                    typeof(AdaptiveFilterLayout),
                                    new PropertyMetadata(null));

    public static readonly DependencyProperty CompactFilterContentProperty =
    ...
    public static readonly DependencyProperty HeaderSpacingProperty =
        DependencyProperty.Register(nameof(HeaderSpacing), typeof(double),
                                    typeof(AdaptiveFilterLayout),
                                    new PropertyMetadata(12d));

    public static readonly DependencyProperty CompactColumnSpacingProperty =
        DependencyProperty.Register(
            nameof(CompactColumnSpacing), typeof(double),
            typeof(AdaptiveFilterLayout),
            new PropertyMetadata(0d, OnLayoutPropertyChanged));

    public static readonly DependencyProperty WideColumnSpacingProperty =
        DependencyProperty.Register(
            nameof(WideColumnSpacing), typeof(double),
            typeof(AdaptiveFilterLayout),
            new PropertyMetadata(20d, OnLayoutPropertyChanged));

    public static readonly DependencyProperty WideMinWidthProperty =
        DependencyProperty.Register(
            nameof(WideMinWidth), typeof(double), typeof(AdaptiveFilterLayout),
            new PropertyMetadata(1050d, OnLayoutPropertyChanged));

    public static readonly DependencyProperty WideFilterWidthProperty =
        DependencyProperty.Register(
            nameof(WideFilterWidth), typeof(double),
            typeof(AdaptiveFilterLayout),
            new PropertyMetadata(292d, OnLayoutPropertyChanged));

    public static readonly DependencyProperty CompactFilterMaxHeightProperty =
        DependencyProperty.Register(
            nameof(CompactFilterMaxHeight), typeof(double),
            typeof(AdaptiveFilterLayout), new PropertyMetadata(620d));

    public static readonly DependencyProperty FilterRailCornerRadiusProperty =
        DependencyProperty.Register(nameof(FilterRailCornerRadius),
                                    typeof(CornerRadius),
                                    typeof(AdaptiveFilterLayout),
                                    new PropertyMetadata(new CornerRadius(10)));

    public static readonly DependencyProperty FilterRailIncludesHeaderProperty =
        DependencyProperty.Register(
            nameof(FilterRailIncludesHeader), typeof(bool),
            typeof(AdaptiveFilterLayout),
    ...
    private void OnSizeChanged(object sender,
                               SizeChangedEventArgs e) => ApplyLayout();

    private void OnCompactFilterOpening(object sender, object e) {
        // Flyout content is hosted outside the normal visual tree, so
        // ElementName bindings from inside the popup can resolve too early or
    ...
    private void ApplyLayout() {
        ...
        FilterRail.Visibility =
            isWide ? Visibility.Visible : Visibility.Collapsed;
        CompactFilterButton.Visibility =
            isWide ? Visibility.Collapsed : Visibility.Visible;
