...
/// <summary>A minimal line chart: plots a bounded series of 0..1 values as a polyline.
/// Dependency-free (no charting package). Bind <see cref="Values"/> to an
/// ObservableCollection&lt;double&gt; of normalized samples.</summary>
public sealed partial class Sparkline : UserControl
{
    ...
    private void OnSeriesChanged(object? sender, NotifyCollectionChangedEventArgs e) => Redraw();
    ...
    private void Redraw()
    {
        ...
        // O(1) count for ObservableCollection (ICollection) instead of enumerating twice.
        int count;
