...
/// <summary>Shared presentation model for an installed provider or automation script.</summary>
public abstract class ScriptEntryItem
{
    protected ScriptEntryItem(
        string id,
        string name,
        string author,
        string version,
    ...
    /// <summary>Last-known enabled state; used only when <see cref="SupportsToggle"/> is true.</summary>
