...
/// <summary>Identifies one of the redirected standard streams on the engine
/// process.</summary>
...
/// <summary>Severity assigned by the Go engine's diagnostic log
/// prefix.</summary>
...
/// <summary>A timestamped line or lifecycle marker observed on an engine
/// standard stream.</summary>
public sealed record EngineStdioEntry(long Sequence, DateTimeOffset Timestamp,
    ...
    /// <summary>Message without the duplicate Go logger timestamp/severity
    /// prefix.</summary>
    public string DisplayMessage {
        get {
            foreach (var marker in SeverityMarkers) {
                var markerIndex =
                    Message.IndexOf(marker, StringComparison.OrdinalIgnoreCase);
