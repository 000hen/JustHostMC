...
public sealed partial class PlayerInventoryDialog : UserControl {
    ...
    private static TextBlock CreateValueText(NbtDetailEntry entry,
                                             Thickness margin) {
        var text = new TextBlock {
            ...
            FontWeight =
                entry.Kind is NbtDetailKind.Enchantment or NbtDetailKind.Effect
